...
public class AuthController : ControllerBase
{
    ...
    public AuthController(LoveAtFirstSightDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
    ...
    public IActionResult Login([FromHeader(Name = "Authorization")] string authHeader)
    {
        try
        {
            ...
            var userRoles = _dbContext.UserRoles.Where(ur => ur.UserId == user.Id.ToString()).ToList();
